...
# Parsing arguments
def get_tasks_args(parser_):
    parser = parser_.add_argument_group(title='tasks')
    ...
    parser.add_argument("--lr_", default=5e-5, type=float)
    ...
    # TODO fix:
    # parser.add_argument("--num-layers", default=24)
    # parser.add_argument("--hidden-size", default=1024)
    # parser.add_argument("--num-attention-heads", default=16)
    # TODO check this:
    parser.add_argument("--max-position-embeddings", default=512)
    return parser_
...
nf.train(
    ...
    optimization_params={'max_steps': 5, "lr_": args.lr}, #{'num_epochs': args.num_epochs, "lr": args.lr}, #
)
